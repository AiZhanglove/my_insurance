...
export default class InsuranceList extends React.Component {
    ...
    goto(res){
        var self = this;
        var myfrom = methods.getParam("from") || "mitulocal";
    ...
    render () {
        ...
        if(this.props.lists.length > 0){
            var currentId = this.props.lists[0].id;
        }else{
            var currentId = 7;
        }
        return (
            <div className="insurancelist-container">
                <div className="channel-banner">
                    {
                        <a href={myurl + "childbuy/" + currentId}><img className="" src="/images/insurance/channel_banner.jpg" alt=""/></a>
                    }
                </div>
